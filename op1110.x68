*- Change log Changed and added OPCODES
...
*--------------------------------
    ...
    CMP.B   #$07,D3     ASL,W memory
    BEQ     _aslMS
*--------------------------------
    JSR get_shift_normal    
*--------------------------------
*------------------------ASL
            CMP.B   #$24,D3     ;ASL.B  Dn,Dn
            BEQ     aslB_RN
             CMP.B  #$2C,D3     ASL.W   Dn,Dn
             BEQ    aslW_RN
             
             CMP.B  #$34,D3
             BEQ    aslL_RN     ASL.L   Dn,Dn
             
             
             *--IMM addressing
             CMP.B  #$20,D3     ASL.B Imm,Dn
             BEQ    aslB_IN 
             
             CMP.B  #$28,D3     ASL.W   Imm,Dn
             BEQ    aslW_IN
             
             CMP.B  #$30,D3     ASL.L   imm,Dn
             BEQ    aslL_IN
